...
## Environments
- Preview: https://main--ups-migration--aemysites.aem.page/
- Live: https://main--ups-migration--aemysites.aem.live/
- Block Library: https://main--ups-migration--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `ups-migration` directory in your favorite IDE and start coding :)
